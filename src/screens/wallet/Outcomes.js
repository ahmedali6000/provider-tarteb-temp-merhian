...
import { dangerHady, domain } from '../../utils/app';
...
export default function Outcomes() {
  ...
  const GET_DATA = () => {
    var config = {method: 'get',url: domain + `/api/gt-outcomes?page=${pageNum}`,headers: {'Authorization': 'Bearer ' + tokenK,'Content-Type': 'application/json','Accept': 'application/json'}};
  ...
  const renderRecord = ({item}) =>{
    return (
      <View  style={[styles.itemWrapper,{backgroundColor:dangerHady}]}>
